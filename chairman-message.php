        ...
        <div class="title_holder">
            ...
            <div class="industify_fn_breadcrumbs">
                <ul>
                    ...
                    <li><span class="bread-current">Chairman Message</span></li>
                </ul>
            </div>
        </div>
    </div>
        ...
        <div class="blueprint_wrap">
            ...
            <div class="blueprint_left">
                <div class="ca_modern_heading">
                    <div class="ghost">OVERSIGHT</div>
                    <h3 class="title">Chairman <span>Message</span></h3>
                    <div class="line"></div>
                </div>
                
                <div class="blueprint_desc">
                    <div class="ceo_quote_container">
                        <img class="fn__svg" src="svg/quotes.svg" alt="quotes" />
                        <p>
                            "Since our inception, Century Paper & Board Mills Limited has been built on a foundation of structural integrity and value generation. As part of the Lakson Group, our mandate is clear: to govern operations ethically, support industrial communities, and build highly responsive, green, and modern production standards that lead the packing industry forward in Pakistan."
                        </p>
                    </div>
                    
                    <div class="ceo_signature_area">
                        <div>
                            <h4>Iqbal Ali Lakhani</h4>
            ...
            <div class="blueprint_right">
                <div class="blueprint_image_frame">
                    ...
                    <div class="image_holder">
                        <img src="webImages/team/IqbalAliLakhani_Chairman.JPG" alt="Iqbal Ali Lakhani - Chairman">
                    </div>
                </div>
            </div>
