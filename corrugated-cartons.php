        ...
        <div class="title_holder">
            ...
            <div class="industify_fn_breadcrumbs">
                <ul>
                    ...
                    <li><span class="bread-current">Corrugated Cartons</span></li>
                </ul>
            </div>
        </div>
    </div>
            ...
            <div class="industify_fn_leftsidebar">
                ...
                <div class="industify_fn_service_single">
                    ...
                    <div class="img_holder">
                        <img src="webImages/portfolio/4.jpg" alt="Century Corrugated Cartons" />
                    </div>

                    <div class="desc_holder">
                        <h3>Regular Slotted Cartons (RSC)</h3>
                        <p>The most commonly used corrugated shipping cartons, featuring flaps of equal length that meet at the center when closed. Suitable for storage, transportation, and distribution of a wide variety of products.</p>
                        
                        <h3>Specialty Cartons</h3>
                        <p>Customized corrugated packaging solutions designed to meet specific product protection, branding, display, and logistics requirements. Available in various sizes, styles, and structural designs.</p>

                        <h3>Tobacco Storage Cartons (C-48)</h3>
                        <p>Heavy-duty corrugated cartons specifically designed for the storage and transportation of tobacco products. Engineered to provide enhanced strength, stacking performance, and protection during handling and warehousing.</p>
                    </div>
                            ...
                            <ul>
                                <li>
                                    <div class="item">
                                        ...
                                        <p>High edge-crush (ECT) test specifications for optimal stacking limits</p>
                                    </div>
                                </li>
                                <li>
                                    <div class="item">
                                        <img class="fn__svg" src="svg/check.svg" alt="svg" />
                                        <p>Custom 3-ply, 5-ply, and 7-ply heavy-duty board configurations</p>
                                    </div>
                                </li>
                                <li>
                                    <div class="item">
                                        <img class="fn__svg" src="svg/check.svg" alt="svg" />
                                        <p>High-resolution flexo printing for branding and barcode scanning visibility</p>
                                    </div>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="container">
                            <div class="cta_holder">
                                <div class="title_holder">
                                    ...
                                    <p>Design your custom 3-ply or 5-ply die-cut corrugated shipping carton formats.</p>
                                </div>
                ...
                <div class="service_list_as_function">
                    ...
                    <div class="list_holder">
                        <ul>
                            ...
                            <li class="active"><a href="corrugated-cartons.php">Corrugated Cartons</a></li>
                        </ul>
                    </div>
                </div>
                <!-- /Service List -->
