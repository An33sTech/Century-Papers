            ...
            foreach($data as $store_id=>$store_val){
                ...
                foreach($store_val as $scale_id=>$scale_val) {
                    ...
                    foreach($scale_val as $color_id=>$color_val) {
                        ...
                        $scaleId1 = empty($scale_id) ? 0 :$scale_id;
                        $colorId1 = empty($color_id) ? 0 :$color_id;

                        @$hashVal1=$new_pid.":".$scaleId1.":".$colorId1.":".$storeID;
                        $hash1 = md5($hashVal1);
...
// $scaleId2 = empty($scale_id) ? 0 :$scale_id;
// $colorId2 = empty($color_id) ? 0 :$color_id;

@$hashVal2=$pid.":".$scaleId.":".$colorId.":".$storeID;
$hash2 = md5($hashVal2);
