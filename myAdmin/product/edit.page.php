                    ...
                    <form id="productDetailTable">
                        ...
                        <table id="">
                            ...
                            <tr>
                                ...
                                <td><input type="text" class="inp" value="<?php echo $p_detail['prodet_name']; ?>" name="<?php echo $product->prefix_productBasicInformation; ?>[name]">
                            ...
                            <tr>
                                ...
                                <td><input type="text" value="<?php echo $p_detail['prodet_tags']; ?>" name="<?php echo $product->prefix_productBasicInformation; ?>[tags]" class="inp f-prodet_tags" data-role="tagsinput"></td>
                            ...
                            <tr>
                                ...
                                <td><textarea name="<?php echo $product->prefix_productBasicInformation; ?>[sdesc]" class="inp "><?php echo $p_detail['prodet_shortDesc']; ?></textarea></td>
                            ...
                            <tr>
                                ...
                                <td><textarea name="<?php echo $product->prefix_productBasicInformation; ?>[ldesc]" class="inp f-prodet_longDesc"><?php echo $p_detail['prodet_longDesc']; ?></textarea>
                                </td>
