...
<div>
    ...
    <ul class="nav nav-tabs tabs_arrow" role="tablist" >
     ...
     <li><a href="#product_tbl" role="tab" data-toggle="tab">Update discount table</a></li>
    </ul>
  ...
  <div class="tab-pane fade container-fluid" id="product_tbl">

            <h2 class="tab_heading">Update discount table</h2>
...
?>" onclick="runDiscounttable()"></th>
    ...
    <script>
        ...
        function runDiscounttable(){

        if(secure_delete('Are you sure you want to run ?')){
            
            window.location = '<?php echo WEB_URL; ?>/cron/cronTasks.php?time=discountTbl';
