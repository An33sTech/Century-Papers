...
if(array_key_exists('pic',$_FILES) && $_FILES['pic']['error'] == 0 ){
    ...
    @$name=$_POST['item_id']."_".$rand.'_'.str_replace($find, $replace, $pic['name']); //IMG name : INSERT PARENT ID_RANDOM NUMBER_IMG NAME;
        ...
        if(move_uploaded_file($pic['tmp_name'], $upload_dir.$name)){
            ...
            switch($page){
                case 'product':
                    ...
                    break;
                case 'productDetail':
                        $ajax->productDetailImage($_POST['item_id'],$saveName);
                    break;
                case 'defect':
