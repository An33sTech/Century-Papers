...
<div id="content">
  <div class='container-fluid'>
    <div class='IBMS_LOGO col-sm-12 text-center'>
      <div style='margin-top: 30px;display: inline-block;'>
        <div style='display: inline-block; vertical-align: middle;float: left;margin-right: 10px;'>
          <img src='images/logo_ibms.png' width='120' loading='lazy' />
        </div>
    ...
    <!--IBMS logo END-->
<a href="https://mega.nz/folder/ouR1WL4R#6aZELi00Swq1zjXctfNHAQ" class="btn btn-lg btn-primary" target="_blank">Demo Videos</a>
    <h2 class='sub_heading borderIfNotabs' style='color:#000'> <?php echo $_e['DASHBOARD'];
                                                                ?>
      <small><?php echo $_e['This is place where everything started'];
              ?></small>
    </h2>
    ...
    <div class='col-sm-12 graphs padding-0'>
      <div class='col-md-8 BigGraphs'>
        ...
        ?>
          <div class='StoreGraph btn-default col-sm-12'>
            <h2><?php echo $_e['Updated Stock Graph'];
                ?></h2>
        ...
        <?php if (
          $hasProduct == '1' && $functions->developer_setting('order_daily_value_report') == '1'
          ...
          <div class="orderGraph btn-default col-sm-12">
            ...
            <div id="order_daily_value_report" class="">
              ...
              <script>
                $.get('graphs.php', {
                  get_graph: 'order_daily_value_report'
                }, function(data) {
                  /*optional stuff to do after success */
        ...
        <?php if (
          $hasProduct == '1' && $functions->developer_setting('order_monthly_report') == '1'
          && $hasCartSystem == '1' && @$dashboard_graphs['order_monthly_report'] == '1'
        ) {
        ?>
          <div class='orderGraph btn-default col-sm-12'>
            <h2><?php echo $_e['Monthly Order Graph'];
                ?></h2>
            <div id='order_monthly_report' class=''>
              ...
              <script>
                $.get('graphs.php', {
                  get_graph: 'order_monthly_report'
                }, function(data) {
                  /*optional stuff to do after success */
        ...
        <?php if (
          $hasProduct == '1' && $functions->developer_setting('order_monthly_value_report') == '1'
          && $hasCartSystem == '1' && @$dashboard_graphs['order_monthly_value_report'] == '1'
        ) {
        ?>
          <div class='orderGraph btn-default col-sm-12'>
            <h2><?php echo $_e['Monthly Order Value Graph'];
                ?></h2>
            <div id='order_monthly_value_report' class=''>
              ...
              <script>
                $.get('graphs.php', {
                  get_graph: 'order_monthly_value_report'
                }, function(data) {
                  /*optional stuff to do after success */
        ...
        <!--monthly_order_status : show how many order in pending, complete, cancel in which month, show 1 year report-->
        <?php if (
          $hasProduct == '1' && $functions->developer_setting('order_yearly_report') == '1'
          && $hasCartSystem == '1' && @$dashboard_graphs['order_yearly_report'] == '1'
        ) {
        ?>
          <div class='orderGraph btn-default col-sm-12'>
            <h2><?php echo $_e['Yearly Order Graph'];
                ?></h2>
        ...
        <?php if (
          $hasProduct == '1' && $functions->developer_setting('order_yearly_value_report') == '1'
          && $hasCartSystem == '1' && @$dashboard_graphs['order_yearly_value_report'] == '1'
        ) {
        ?>
          <div class='orderGraph btn-default col-sm-12'>
            <h2><?php echo $_e['Yearly Order Value Graph'];
                ?></h2>
            <div id='order_yearly_value_report' class=''>
              ...
              <script>
                $.get('graphs.php', {
                  get_graph: 'order_yearly_value_report'
                }, function(data) {
                  /*optional stuff to do after success */
        ...
        <?php if (
          $hasProduct == '1' && $functions->developer_setting('product_sale_by_store_daily') == '1'
          ...
          <div class="product_sale_by_store_daily btn-default col-sm-12">
            ...
            <div id="product_sale_by_store_daily" class="">
              ...
              <script>
                $.get('graphs.php', {
                  get_graph: 'product_sale_by_store_daily'
                }, function(data) {
                  /*optional stuff to do after success */
        ...
        <?php if (
          $hasProduct == '1' && $functions->developer_setting('product_sale_by_store_monthly') == '1'
        ...
        ?>
          <div class='product_sale_by_store_monthly btn-default col-sm-12'>
            <h2><?php echo $_e['Monthly Order By Store'];
                ?></h2>
            <div id='product_sale_by_store_monthly' class=''>
              ...
              <script>
                $.get('graphs.php', {
                  get_graph: 'product_sale_by_store_monthly'
                }, function(data) {
                  /*optional stuff to do after success */
        ...
        <?php if (
          $hasProduct == '1' && $functions->developer_setting('whole_sale_report') == '1'
          && @$dashboard_graphs['whole_sale_report'] == '1'
        ) {
        ?>
          <div class='whole_sale_report btn-default col-sm-12'>
            <h2><?php echo $_e['Active Whole Sale Offers'];
                ?></h2>
      ...
      <div class="col-md-4 smallGraph padding-0">
        ...
        <?php if (
          $hasProduct == '1' && $functions->developer_setting('return_Product_from_client') == '1'
        ...
        <?php if (
          $hasProduct == '1' && $functions->developer_setting('defect_Product_from_client') == '1'
        ...
        <?php if (
          $hasProduct == '1' && $functions->developer_setting('total_order_status') == '1'
        ...
        <?php if (
          $hasProduct == '1' && $functions->developer_setting('top_order_user') == '1'
        ...
        <!--top_order_user : top user by price or by order-->
        <?php if (
          $hasProduct == '1' && $functions->developer_setting('top_payment_method') == '1'
        ...
        <?php if (
          $hasProduct == '1' && $functions->developer_setting('no_of_product_report') == '1'
          ...
          <div class="orderGraph btn-default col-sm-12">
            ...
            <div id="no_of_product_report" class="graphDiv">
              ...
              <script>
                $.get('graphs.php', {
                  get_graph: 'no_of_product_report'
                }, function(data) {
                  /*optional stuff to do after success */
        ...
        <?php if (
          $functions->developer_setting('subscribe_status') == '1'
        ...
        if (
          $functions->developer_setting('email_sending_status') == '1'
        ...
        ?>
          <div class="orderGraph btn-default col-sm-12">
            ...
            <div id="email_sending_status" class="graphDiv">
              ...
              <script>
                $.get('graphs.php', {
                  get_graph: 'email_sending_status'
                }, function(data) {
                  /*optional stuff to do after success */
