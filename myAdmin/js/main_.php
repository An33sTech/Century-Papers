...
<?php // ####### product edit on click binding here in jquery. ?>
        ...
        $('.dTable tbody, .dTable_ajax tbody, .dTable_ajax1 tbody, .dTable_ajaxOrder tbody').on('click', 'tr', function () {
            fc.anchorByPost("a[data-method='post']");
        } );

        $(".dTable tbody, .dTable_ajax tbody, .dTable_ajax1 tbody, .dTable_ajaxOrder tbody").on( "click", "a[data-method='post']", function() {
   ...
   table = $('.dTable').DataTable( {
    ...
    $('.dTable_ajax').each(function(){
        ...
        OrdersTable.on( 'xhr', function () {
            console.log( 'Table load completed', window );
    ...
    $('.dTable_ajax_lang').each(function(){
        url = $(this).attr("data-href");
        uniq = $(this).attr("data-uniq");
        <?php # add uniq as $_GET param on the current link ?>
        url = url + "&uniq="+ uniq;
    ...
    $('.dTable_ajaxOrder').each(function(){
        url  = $(this).attr("data-href");
        uniq = $(this).attr("data-uniq");
        <?php #### ////// columnDefs is used in columnDefs of dataTable. ?>
        var columnDefs;
