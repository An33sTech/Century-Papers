...
class email_ajax extends object_class{
    ...
    public function activeEmail(){
        ...
        try{
            ...
            $sql2="UPDATE email_subscribe SET verify = ? WHERE id = ?";
            $this->dbF->setRow($sql2,array($verify, $id), false);
            if($this->dbF->rowCount) echo '1';
            else echo '0';
    ...
    public function emailGrp(){
        ...
        try{
            ...
            $sql2="UPDATE email_subscribe SET `grp` = ? WHERE id=?";
            $this->dbF->setRow($sql2,array($grp,$id),false);
            if($this->dbF->rowCount) echo '1';
            else echo '0';
    ...
    public function startQueue(){
        ...
        try{
            ...
            $sql2="UPDATE email_letter_queue set status = ? WHERE letter_id = ? AND grp = ?";
            $this->dbF->setRow($sql2,array($val,$letterId,$grp),false);
            if($this->dbF->rowCount) echo '1';
            else echo '0';
