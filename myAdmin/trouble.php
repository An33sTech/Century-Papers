...
<head>
    ...
    <link rel="stylesheet" type="text/css"
        href="<?php echo WEB_ADMIN_URL; ?>/assets/font-awesome/css/font-awesome.css" />
    <link rel="stylesheet" type="text/css"
        href="<?php echo WEB_ADMIN_URL; ?>/assets/jquery-ui/css/jquery-ui-1.11.0.css" />
    <link rel="stylesheet" type="text/css" href="<?php echo WEB_ADMIN_URL; ?>/assets/bootstrap/css/bootstrap.css" />
    <link rel="stylesheet" type="text/css"
        href="<?php echo WEB_ADMIN_URL; ?>/assets/bootstrap/css/bootstrap-theme.css" />
    <!-- custome css -->
                ...
                <div class="container-fluid">
                    ...
                    <div class="navbar-collapse collapse">
                        <ul class="nav navbar-nav">
                            <li class="active"><a href="<?php echo WEB_URL; ?>"> <i class="fa fa-home"
                                        style="font-size: 18px"></i> <?php echo $_e['Go To Home']; ?></a></li>
                        </ul>
                                        ...
                                        <form method="post" action="?do=resend&r=email" class="again form-horizontal">
                                            <div class="form-group">
                                                <label for="inputEmail3"
                                                    class="col-sm-2  control-label"><?php echo _uc($_e['Email']); ?></label>
                                                <div class="col-sm-10">
                                                    <input type="email" required="" value="<?php echo $email; ?>"
                                                        class="form-control" name="email" id="inputEmail3"
                                                        placeholder="<?php echo _uc($_e['Email']); ?>">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label
                                                    class="col-sm-2 control-label"><?php echo _uc($_e['Security Captcha']); ?></label>

                                                <div class="col-sm-10">
                                                    <div class="col-sm-5"><img src="<?php echo WEB_URL; ?>/captcha.php"
                                                            alt="Please Type The Code." /></div>
                                                    <div class="col-sm-7">
                                            ...
                                            <div class="form-group">
                                                <div class="col-sm-12">
                                                    <a href="<?php echo WEB_ADMIN_URL ?>" class="btn btn-success">
                                                        <?php echo _u($_e['LOGIN']); ?> </a>
                                                    <button type="submit"
                                                        class="btn btn-primary defaultSpecialButton"><?php echo _uc($_e['Send Email']); ?></button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
