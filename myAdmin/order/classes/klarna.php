...
class myKlarna extends object_class{
    ...
    public function __construct(){
        ...
        if($this->functions->isAdminLink()){
            ...
            $currency = @$_SESSION['webUser']['currencyC'];
    ...
    public function klarnaCountry(){
        ...
        }    else if(strtoupper($currentCountry) == 'DK'){
        // denmark
          $this->purchase_country = 'DK';
 $this->purchase_currency = 'DKK';
       $this->locale = 'da-dk';
        ...
        }else if(strtoupper($currentCountry) == 'CH'){
            ...
            $this->purchase_country = 'CH';



            $this->purchase_currency = 'CHF';
        ...
        }else if(strtoupper($currentCountry) == 'FR'){
        ...
        }else if(strtoupper($currentCountry) == 'NL'){
        ...
        }else if(strtoupper($currentCountry) == 'US'){
            ...
            $this->purchase_country = 'US';



            $this->purchase_currency = 'USD';
        ...
        }else if(strtoupper($currentCountry) == 'BE'){
        ...
        }else if(strtoupper($currentCountry) == 'GB'){
            ...
            $this->purchase_country = 'GB';



            $this->purchase_currency = 'GBP';
        ...
        }else if(strtoupper($currentCountry) == 'ES'){
        ...
        }else if(strtoupper($currentCountry) == 'IT'){
    ...
    public function klarnaActiveInvoice(){
        ...
        try {
            ...
            $sql ="UPDATE order_invoice SET rsvNo_done = ?, `rsvNo` = ? WHERE order_invoice_pk = ?";



            $this->dbF->setRow($sql, array($klarna_reference, $capture_id, $id), false);
    ...
    public function klarnaActiveExtraInvoice(){
        ...
        try {
            ...
            $sql ="UPDATE order_extra_amount SET rsvNo_done = ?, `rsvNo` = ? WHERE id = ?";
