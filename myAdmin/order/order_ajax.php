...
if(isset($_GET['page'])){
 ...
 case 'data_ajax_forAllAndCompleted_complete':
        ...
        case 'data_ajax_forAllAndCompleted_all':
            
             case 'data_ajax_forAllAndCompleted_manullayCreated':


            $ajax->order_fetch_forAllAndCompleted($page);
   ...
   case 'data_ajax_inc':
        ...
        case 'getTemplateDetail':
            ...
            break;
                 ...
                 case 'saveRecordSPonline':
            $ajax->saveRecordSPonline();
            break;
        ...
        case 'readyOrdersCount':
            $ajax->readyOrdersCount();
            break;        
            
        case 'semiReadyOrdersCount':
            $ajax->semiReadyOrdersCount();
            break;             
            
            case 'invoiceDetailAjax':
            $ajax->invoiceDetailAjax();
            break;        
