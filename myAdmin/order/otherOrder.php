...
?>
    ...
    <ul class="nav nav-tabs tabs_arrow" role="tablist">
        <li class="active"><a href="#compOrder" role="tab" data-toggle="tab"><?php echo _uc($_e['Complete Orders']); ?></a></li>
        ...
        <li class="add_new_order"><a href="#inc" role="tab" data-toggle="tab">Incomplete Data</a></li>
...
?>
        ...
        <div class="tab-pane fade in active container-fluid" id="compOrder">
            ...
            <?php $order->invoiceListFORallandComplete('complete'); ?>
        </div>
        ...
        <div class="tab-pane fade container-fluid" id="incompOrder">
            <div class="heading_invoice">
            ...
            <div>
                <a href="-order?page=newOrder&deleteIncomplete" class="btn btn-info btn-sm"><?php echo _n($_e['Delete All Old Incomplete Orders']); ?></a>
            </div>
        ...
        <div class="tab-pane fade container-fluid" id="inc">
            <div class="heading_invoice">
                <h2 class="tab_heading"><?php echo _uc($_e['All Orders']); ?></h2>
            </div>
            <?php $order->invoiceList2('inc'); ?>
        </div>
