...
<style>
 ...
 <!--        <li class="active"><a href="#home" role="tab" data-toggle="tab"><?php #echo _uc($_e['InProcess Invoices']); ?></a></li>
        <li class="all_orders"><a href="#allOrder" role="tab" data-toggle="tab"><?php #echo _uc($_e['All Orders']); ?></a></li>
        ...
        <li class="add_new_order in active"><a href="#newOrder" role="tab" data-toggle="tab"><?php echo _uc($_e['Add New Order']); ?></a></li>
    </ul>
...
?>
        ...
        <div class="tab-pane fade container-fluid" id="compOrder">
            <div class="heading_invoice">
        ...
        <div class="tab-pane fade in active container-fluid" id="newOrder">
...
.small_btn{
    ...
    <script src="adminorder/js/order.php"></script>
