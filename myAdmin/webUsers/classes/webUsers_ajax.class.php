...
class webusers_ajax extends object_class{
    ...
    public function activeWebUser(){
        ...
        try{
            ...
            $sql2="UPDATE accounts_user SET acc_type = ? WHERE acc_id = ?";
    ...
    public function activeSponsor(){
        ...
        try{
            ...
            $sql2="UPDATE accounts_user SET acc_role = ? WHERE acc_id = ?";
            $this->dbF->setRow($sql2,array($verify, $id), false);
            if($this->dbF->rowCount) echo '1';
            else echo '0';
    ...
    public function activeAdminUser(){
        ...
        try{
            ...
            $sql2="UPDATE accounts SET acc_type = ? WHERE acc_id = ? AND acc_role != ?";
            $this->dbF->setRow($sql2,array($verify, $id, 0), false);
            if($this->dbF->rowCount) echo '1';
            else echo '0';
